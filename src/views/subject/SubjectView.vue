  ...
  <div class="subjects-management-page">
    ...
    <header class="page-top-header">
      <div class="title-group">
        <h1 class="management-title">Subjects Management</h1>
      </div>
    ...
    <div class="action-bar-container">
      <BaseSearch v-model="searchQuery" placeholder="Search subjects..." @search="handleSearch" />
    </div>

    <BaseCard class="table-card-wrapper">
      <BaseTable :columns="columns" :items="paginatedSubjects" :is-loading="subjectStore.isLoading" @view="handleView"
    ...
    <div class="stats-footer-grid">
      <StatCard label="Total Items" :value="subjectStore.subjects?.length || 0" icon="bi-layers" iconColor="blue"
    ...
    <!-- Modals Section -->
    <BaseModal :show="showFormModal" :title="isEditing ? 'Update Subject' : 'Add New Subject'"
      ...
      <div class="form-group">
        <BaseInput v-model="form.name" label="Subject Name" placeholder="Enter subject name..." required
          :error="errors.name" @blur="validate('name')" />
      </div>
      <template #footer>
        <button class="modal-btn cancel" :disabled="subjectStore.isProcessing"
    ...
    <BaseModal :show="showDetailsModal" title="Subject Details" subtitle="View complete information about this subject"
    ...
    <BaseModal :show="showDeleteModal" title="Delete Subject ?" subtitle="This action cannot be undone"

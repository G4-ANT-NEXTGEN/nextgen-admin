  ...
  <div class="schools-management-page">
    ...
    <header class="page-top-header">
      <div class="title-group">
        <h1 class="management-title">Schools Management</h1>
      </div>
    ...
    <div class="stats-footer-grid">
      <StatCard label="Total Items" :value="schoolStore.schools?.length || 0" icon="bi-layers" iconColor="blue"
        :isLoading="schoolStore.isLoading" />
    ...
    <!-- Modals Section -->
    <BaseModal :show="showFormModal" :title="isEditing ? 'Update School' : 'Add New School'"
      ...
      <div class="form-group">
        <BaseInput v-model="form.name" label="School Name" placeholder="Enter school name..." required
          :error="errors.name" @blur="validate('name')" />
      </div>
      <template #footer>
        <button class="modal-btn cancel" :disabled="schoolStore.isProcessing"
    ...
    <BaseModal :show="showDetailsModal" title="School Details" subtitle="View complete information about this school"
    ...
    <BaseModal :show="showDeleteModal" title="Delete School ?" subtitle="This action cannot be undone"

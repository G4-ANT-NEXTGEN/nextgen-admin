  ...
  <div class="skills-management-page">
    ...
    <header class="page-top-header">
      <div class="title-group">
        <h1 class="management-title">Skills Management</h1>
      </div>
    ...
    <div class="action-bar-container">
      <BaseSearch v-model="searchQuery" placeholder="Search skills..." @search="handleSearch" />
    </div>

    <BaseCard class="table-card-wrapper">
      <BaseTable :columns="columns" :items="paginatedSkills" :is-loading="skillStore.isLoading" @view="handleView"
    ...
    <div class="stats-footer-grid">
      <StatCard label="Total Items" :value="skillStore.skills?.length || 0" icon="bi-layers" iconColor="blue"
    ...
    <!-- Modals Section -->
    <BaseModal :show="showFormModal" :title="isEditing ? 'Update skill' : 'Add New Skill'"
      ...
      <div class="form-group">
        <BaseInput v-model="form.name" label="Skill Name" placeholder="Enter skill name..." required
          :error="errors.name" @blur="validate('name')" />
      </div>
      <template #footer>
        <button class="modal-btn cancel" :disabled="skillStore.isProcessing"
    ...
    <BaseModal :show="showDetailsModal" title="Skill Details" subtitle="View complete information about this skill"
    ...
    <BaseModal :show="showDeleteModal" title="Delete Skill ?" subtitle="This action cannot be undone"

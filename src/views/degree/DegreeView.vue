<template>
  <div class="degrees-management-page">
    ...
    >
      <div class="form-group">
        ...
        <input v-model="form.name" type="text" class="custom-input" placeholder="Enter degree name...">
      </div>
      <template #footer>
    ...
    >
      ...
      <div class="details-grid">
        ...
        <div class="detail-card full">
          <label><i class="bi bi-card-text"></i> Degree Name</label>
    ...
    >
      ...
      <div class="confirmation-content">
        <p class="confirm-message">
          ...
          This will permanently remove the degree and all associated data from the system.
        </p>
...
const paginatedDegrees = computed(() => {
  ...
  return (degreeStore.degrees || []).slice(start, end)
})

// Reset pagination when data changes
watch(() => degreeStore.degrees?.length, () => {
  currentPage.value = 1
})
